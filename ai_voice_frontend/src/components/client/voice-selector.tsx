...
export function VoiceSelector({ service }: { service: ServiceType }) {
    ...
    return (<div className="relative" ref={dropdownRef}>
                ...
                className="border-gray200 flex items-center justify-between rounded-xl border border-gray-200 px-3 py-2 hover:cursor-pointer hover:bg-gray-100 hover:bg-opacity-30">
